...
#ifndef TENSORS0ABASE_CHEMPS2_H
#define TENSORS0ABASE_CHEMPS2_H
...
/** TensorS0Abase class.
    ...
    The TensorS0Abase class is a storage class for TensorS0 and TensorA. It also performs the update of a previous TensorS0Abase based on movingRight.*/
   class TensorS0Abase : public Tensor{
      ...
      public:
         ...
         TensorS0Abase(const int indexIn, const int IdiffIn, const bool movingRightIn, const SyBookkeeper * denBKIn);
         
         //! Destructor
         virtual ~TensorS0Abase();
         ...
         //! Clear and update
         /** \param S0AbasePrevious TensorS0Abase needed for the update
             \param denT TensorT needed for the update.
             \param workmem Work memory */
         void update(TensorS0Abase * S0AbasePrevious, TensorT * denT, double * workmem);
      ...
      private:
         ...
         void updateMovingRight(TensorS0Abase * S0AbasePrevious, TensorT * denT, double * workmem);
         
         //update when movingleft
         void updateMovingLeft(TensorS0Abase * S0AbasePrevious, TensorT * denT, double * workmem);
