...
/** Sobject class.
   ...
   class Sobject{
      ...
      public:
         ...
         //! Constructor
         /** \param indexIn The first index (i ; S spans i & i+1)
             \param IlocalIn1 The local irrep index of site i
             \param IlocalIn2 The local irrep index of site i+1
             \param denBKIn Contains the virtual dimensions. Not const as Sobject is allowed to set the virtual dimensions of symmetry sectors based on the Schmidt spectrum. */
